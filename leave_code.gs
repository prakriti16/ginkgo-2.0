// online link : https://script.google.com/d/16SDgRaOnn1HCpaLnvcII297RczH1MnJswy64ynb_6OfJkj7__n3fNHgZ/edit?usp=sharing
...
{  var ss = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1izdQ4X3JBCAVAmj3js2yXir1DMQPMpmbNAVwgPAEELg/edit#gid=0"); // Replace with your spreadsheet URL
  ...
  var walmiSpreadsheet = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1izdQ4X3JBCAVAmj3js2yXir1DMQPMpmbNAVwgPAEELg/edit#gid=1157135217"); // Replace with the correct URL of your "Walmi" spreadsheet
  
  var destinationSheet=0;
  destinationSheet = walmiSpreadsheet.getSheetByName("Leave");
