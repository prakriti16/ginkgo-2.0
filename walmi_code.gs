// online link - https://script.google.com/d/1X7fLJRZZJ58I0LZ2xS7adnn73uEYlQOQcc1xK7DOc3bCKjWltUnhniYi/edit?usp=sharing
function doGet(e) {
...
{  var ss = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1izdQ4X3JBCAVAmj3js2yXir1DMQPMpmbNAVwgPAEELg/edit#gid=0"); // Replace with your spreadsheet URL
  ...
  var walmiSpreadsheet = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1izdQ4X3JBCAVAmj3js2yXir1DMQPMpmbNAVwgPAEELg/edit#gid=0"); // Replace with the correct URL of your "Walmi" spreadsheet
  
  var destinationSheet=0;
  destinationSheet = walmiSpreadsheet.getSheetByName("walmi1");
